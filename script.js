...
function showTime() {
  ...
  document.getElementById("WatchDay").innerText = humanReadableDate;
}
showTime();
setInterval(showTime, 1000);

document.getElementById("WatchName").innerHTML = "ERDİNÇ ÖZDEMİR";
let firstName1 = prompt("Lütfen Adınızı Giriniz!");
document.getElementById("Yazı").innerHTML = ` Hoşgeldin ${firstName1}, <br>
HAYATTA 1 SN BİLE ÇOK DEĞERLİ !!! `;
